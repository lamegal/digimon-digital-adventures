...
INPUT_JSON = Path("output/all_digimon_with_evolution_index_v4.json")
INPUT_UNRESOLVED = Path("output/evolution_index_unresolved_v4.csv")
OUT_DIR = Path("output/audit_v4")
