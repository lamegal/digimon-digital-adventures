...
OUTPUT_PATH = Path("output/all_digimon_with_evolution_index_v4.json")
REPORT_PATH = Path("output/evolution_index_report_v4.json")
UNRESOLVED_PATH = Path("output/evolution_index_unresolved_v4.csv")
