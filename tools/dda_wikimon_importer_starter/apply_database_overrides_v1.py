...
DEFAULT_OUTPUT = Path("output/all_digimon_curated_v1.json")
DEFAULT_REPORT = Path("output/curation_report_v1.json")
DEFAULT_DUPES_CSV = Path("output/curation_merged_duplicates_v1.csv")
DEFAULT_STAGE_CSV = Path("output/curation_stage_changes_v1.csv")
...
def main():
    ...
    if not overrides_path or not overrides_path.exists():
        raise SystemExit("Arquivo de overrides não encontrado. Coloque database_overrides_v1.json na pasta output ou informe --overrides.")
